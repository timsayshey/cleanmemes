(function($) {
    ...
    ParseApplicationId = "rm4NxbY4BEnbdoLW20gZCJSw4VRns7wxvQ4bBgxm";
    ParseRESTAPIKey = "unbKWncuNpim67AqnHHIKJd4l94P0Ed2fTIBhFrB";
    ...
    //uriRgx
    uriRgx = /(files|installations|login|push|roles|functions|requestPasswordReset|users)/;
  ...
  */
    $.each(['GET', 'REMOVE', 'POST', 'PUT'], function(i, action) {
